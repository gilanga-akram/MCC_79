...
namespace API.Services
{
    public class RoomService
    {
        ...
        private readonly IRoomRepository _roomRepository, _bookingRepository;
        public RoomService(IRoomRepository roomRepository,IRoomRepository bookingRepository)
        {
